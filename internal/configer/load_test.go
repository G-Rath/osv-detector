...
func TestFind_NoConfig(t *testing.T) {
	...
	config, err := configer.Find(r, filepath.FromSlash("testdata/no-config"))
...
func TestFind_ExtYml(t *testing.T) {
	...
	expectedFilePath := filepath.FromSlash("testdata/ext-yml/.osv-detector.yml")

	config, err := configer.Find(r, filepath.FromSlash("testdata/ext-yml"))
...
func TestFind_ExtYml_Invalid(t *testing.T) {
	...
	expectedFilePath := filepath.FromSlash("testdata/ext-yml-invalid/.osv-detector.yml")

	config, err := configer.Find(r, filepath.FromSlash("testdata/ext-yml-invalid"))
...
func TestFind_ExtYaml(t *testing.T) {
	...
	expectedFilePath := filepath.FromSlash("testdata/ext-yaml/.osv-detector.yaml")

	config, err := configer.Find(r, filepath.FromSlash("testdata/ext-yaml"))
...
func TestFind_ExtYaml_Invalid(t *testing.T) {
	...
	expectedFilePath := filepath.FromSlash("testdata/ext-yaml-invalid/.osv-detector.yaml")

	config, err := configer.Find(r, filepath.FromSlash("testdata/ext-yaml-invalid"))
...
func TestLoad(t *testing.T) {
	...
	fixturePath := filepath.FromSlash("testdata/extra-databases/.osv-detector.yml")
