...
func TestParsePylock_FileDoesNotExist(t *testing.T) {
	...
	packages, err := lockfile.ParsePylock("fixtures/pylock/does-not-exist")
...
func TestParsePylock_InvalidToml(t *testing.T) {
	...
	packages, err := lockfile.ParsePylock("fixtures/pylock/not-toml.txt")
...
func TestParsePylock_NoPackages(t *testing.T) {
	...
	packages, err := lockfile.ParsePylock("fixtures/pylock/empty.toml")
...
func TestParsePylock_OnePackage(t *testing.T) {
	...
	packages, err := lockfile.ParsePylock("fixtures/pylock/one-package.toml")
...
func TestParsePylock_TwoPackages(t *testing.T) {
	...
	packages, err := lockfile.ParsePylock("fixtures/pylock/two-packages.toml")
...
func TestParsePylock_Example(t *testing.T) {
	...
	packages, err := lockfile.ParsePylock("fixtures/pylock/example.toml")
